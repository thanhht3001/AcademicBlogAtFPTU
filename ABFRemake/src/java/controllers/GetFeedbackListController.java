 ...
 * @author Bat
 */
@WebServlet(name = "GetFeedbackListController", urlPatterns = {"/GetFeedbackListController"})
public class GetFeedbackListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<FeedbackDTO> fb = dao.getAllFeedback();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetFeedbackListController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
